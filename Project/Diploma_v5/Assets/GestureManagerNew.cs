...
{
   /* public class GestureManagerNew : Singleton<GestureManagerNew>
    {
        internal GameObject FocusedGameObject;
        ...
        {
            if (NewHandsManager.Instance.FocusedGameObject != null)
            {
                IsManipulating = true;

                ManipulationPosition = position;

                NewHandsManager.Instance.FocusedGameObject.SendMessageUpwards("PerformManipulationStart", position);
            }
        }
        ...
        private void ManipulationRecognizer_ManipulationUpdatedEvent(InteractionSourceKind source, Vector3 position, Ray ray)
        {
            if (NewHandsManager.Instance.FocusedGameObject != null)
            {
                ...
                NewHandsManager.Instance.FocusedGameObject.SendMessageUpwards("PerformManipulationUpdate", position);
            }
        }
